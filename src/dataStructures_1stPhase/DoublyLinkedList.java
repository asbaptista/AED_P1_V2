package dataStructures_1stPhase;

import dataStructures_1stPhase.exceptions.*;
import java.io.*;
...
public class DoublyLinkedList<E> implements TwoWayList<E>, Serializable {
     ...
     * Writes the size of the list and then each element in order.
     *
     ...
     * Reads the size of the list and then reads each element,
     * adding it to the end of the list to reconstruct the state.
     *
     * @apiNote Time Complexity: O(N) (since addLast is O(1), N calls = O(N)).
    ...
    private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
        ...
        // head, tail, and currentSize are transient and thus null/0.
        // The addLast method will correctly initialize and update them.
