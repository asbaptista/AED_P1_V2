...
public class AreaImpl implements Area, Serializable {
    ...
    /**
     * Custom serialization method. Uses default serialization logic,
     * which relies on the fields (like {@link StudentsCollectionImpl}
     * and {@link ServicesCollectionImpl}) being Serializable themselves.
     *
    ...
    /**
     * Custom deserialization method. Uses default deserialization logic.
     *
