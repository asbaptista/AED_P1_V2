...
public interface SortedList<E>  {
     ...
     * @apiNote Time Complexity: O(N) (linear search in worst case)
     ...
     * @apiNote Time Complexity: O(N) (linear search for insertion position in worst case)
     ...
     * @apiNote Time Complexity: O(N) (linear search for element to remove)
