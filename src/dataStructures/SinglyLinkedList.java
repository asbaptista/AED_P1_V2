...
public class SinglyLinkedList<E> implements List<E>{
     ...
     *
     * @apiNote Time Complexity: O(N) (Best-case O(1) if pos=0; Worst-case O(N) if pos=size-1)
     ...
     * Otherwise, returns -1.
     *
     * @apiNote Time Complexity: O(N) (Best-case O(1) if at head; Worst-case O(N))
     ...
     *
     * @apiNote Time Complexity: O(N) (Best-case O(1) if pos=0 or pos=size; Worst-case O(N))
     ...
     *
     * @apiNote Time Complexity: O(N) (needs to traverse to find second-to-last node)
     ...
     *
     * @apiNote Time Complexity: O(N) (Best-case O(1) if pos=0; Worst-case O(N))
